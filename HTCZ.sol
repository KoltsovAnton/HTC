 ...
 */
contract HTCZToken is StandardToken {
    string public constant name = "Hit The Crypto Zero"; // solium-disable-line uppercase
    string public constant symbol = "HTCZ"; // solium-disable-line uppercase
